  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        nastaliq: ['"Hussaini Nastaleeq"', '"Noto Nastaliq Urdu"', 'Parastoo', 'Katibeh', 'serif'],
        ...
        persianDisplay: ['"Hussaini Nastaleeq"', '"Noto Nastaliq Urdu"', 'Katibeh', '"Aref Ruqaa"', 'serif'],
        persianSerif: ['Parastoo', 'Katibeh', 'Amiri', 'serif'],
