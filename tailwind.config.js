  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        nastaliq: ['"Noto Nastaliq Urdu"', 'Katibeh', 'Amiri', 'serif'],
        katibeh: ['Katibeh', 'Amiri', 'serif'],
        ruqaa: ['"Aref Ruqaa"', 'Katibeh', 'Amiri', 'serif'],
        amiri: ['Amiri', 'serif'],
        lateef: ['Lateef', 'Amiri', 'serif'],
        marhey: ['Marhey', 'Katibeh', 'sans-serif'],
        persianDisplay: ['"Noto Nastaliq Urdu"', 'Katibeh', '"Aref Ruqaa"', 'Amiri', 'serif'],
        persianSerif: ['Katibeh', 'Amiri', 'serif'],
        persianSans: ['Vazirmatn', 'system-ui', 'sans-serif'],
      },
      borderRadius: {
        '2xl': '1.5rem',
        '3xl': '2rem',
