  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="rounded-[2.5rem] p-2 bg-gradient-to-b from-sage-200/40 via-champagne-200/40 to-white/60 shadow-luxury max-w-3xl mx-auto border border-gold/25">
